...
<template>
  <div>
    <header class="home-header" :class="{'active': headerScroll}">
      <router-link tag='span' to='./category'><van-icon name="ellipsis" /></router-link>
      <div class="header-search">
        <span class="app-name">新蜂商城</span>
        <i class="icon-search"> </i>
        <router-link tag='span' class="search-title" to='./product-list'>山河无恙，人间皆安</router-link>
      </div>
      <router-link tag="span" to='./login'><van-icon name="contact" /></router-link>
    </header>
...
export default {
 ...
 setup() {
   ...
   const state = reactive({
     swiperList: [], // 轮播图列表
     isLogin: false, 
     headerScroll: false, // header 滚动透明判断
     hots: [],
     newGoodses: [],
     recommends: [],
     categoryList: [
  ...
  const goToDetail = (item) => {
    console.log('ts',item.goodsId,item)
