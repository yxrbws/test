<template>
    <div class="moneyContainer">
        <div class="money">
            <div>
                <p class="line1">当前余额 <span class="glyphicon glyphicon-question-sign" @click="goToMoneyInfo()">余额说明</span></p>
                <p class="line2"><b>{{money}}</b>元</p>
...
export default {
    ...
    methods:{
        goToMoneyInfo(){
            this.$router.push({name: 'answer', query:{key: 'balanceCaption'}})
        }
    }
}
</script>
